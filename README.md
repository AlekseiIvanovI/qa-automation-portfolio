...
|---------|-----------------|------|------|
| Selenium POM Framework | 50+ automated scripts, regression time ↓35% | Python, Selenium, pytest, POM | [[selenium-pom-framework](https://github.com/AlekseiIvanovI/selenium-pom-framework)(link) ](selenium-pom-framework)|
